const socket=io();const $=id=>document.getElementById(id),menu=$("menu"),lobby=$("lobby"),game=$("game"),results=$("results"),canvas=$("canvas"),ctx=canvas.getContext("2d");let prepRound=-1,prepActive=false, cosmetics={color:"#7dd3fc",upper:"none",lower:"none"},room=null,me=null,players={},rockets=[],powerups=[],eventName=null,eventUntil=0,keys={},last=0,audio=null,settings=JSON.parse(localStorage.getItem("cs2audio")||'{"music":0.18,"sfx":0.35,"muteMusic":false,"muteSfx":false}'),musicTimer=null,localPos={},fx=[];
